...
public class IndexController {
	...
	public String index(Model model,Article article,@RequestParam(defaultValue = "1")Integer page,
		...
		hot24article.setCreated(DateUtil.subDate(new Date()));//调用工具类，系统时间向前推减24个小时
		PageInfo<Article> hot24articleInfo = articleService.selects(hot24article, 1, 4);//热点24小时热文，显示4条
