...
import com.liuxingchen.cms.dao.ArticleMapper;
...
public class ArticleServiceImpl implements ArticleService {
	...
	@Autowired
	private ArticaleRepository articaleRepository;
	...
	public boolean update(Article article) {
		...
		if (article.getStatus() == 1 && article.getDeleted() == 0) {
			articaleRepository.save(article);
		} else {
			/** 否则从索引库删除 **/
			articaleRepository.delete(article);
		}
		return result;
	}
